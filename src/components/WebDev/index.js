    ...
    return (
      <div className="container show-on-scroll">
        ...
        <Row className="portfolio">
          ...
          <Col s={12} l={4}>
            <a href="https://up-style-clothing.herokuapp.com/" className="link">
              upStyle Clothing
            </a>
            <a
          ...
          <Col s={12} l={4}>
            ...
            <a href="https://github.com/exumc/Cars-Such" className="link right">
              <i className="fab fa-github "></i>Code
            </a>
            <img
              src="../images/3.jpg"
        ...
        <Row>
          <p className="disclaimer center">
            Some of the above websites funcionalities may no longer be workding
            due to free or limited access APIs.
          </p>
        </Row>
      </div>
    );
